...
exports.FinancingCalculationService = void 0;
class FinancingCalculationService {
    /**
     * Calcula la cuota mensual usando la fórmula de amortización francesa
     */
    static calculateMonthlyPayment(loanAmount, interestRate, termMonths) {
        if (interestRate === 0) {
     ...
     */
    static generatePaymentSchedule(loanAmount, interestRate, termMonths, startDate, downPayment = 0) {
     ...
     */
    static calculateFinancingSummary(loanAmount, interestRate, termMonths, startDate, paymentsMade, totalPaid, downPayment = 0) {
        const calculation = this.generatePaymentSchedule(loanAmount, interestRate, termMonths, startDate, downPayment);
        const netLoanAmount = loanAmount - downPayment;
     ...
     */
    static validateFinancingParameters(loanAmount, interestRate, termMonths, downPayment = 0) {
        const errors = [];
        if (loanAmount <= 0) {
