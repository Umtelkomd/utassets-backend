...
var ProjectRepository = /** @class */ (function (_super) {
    ...
    function ProjectRepository() {
        return _super.call(this, Project_1.Project, data_source_1.AppDataSource.createEntityManager()) || this;
    }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.save(newProject)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    ProjectRepository.prototype.getAllProjects = function () {
        return __awaiter(this, void 0, Promise, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ProjectRepository.prototype.updateProject = function (id, project) {
        return __awaiter(this, void 0, Promise, function () {
            var existingProject;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.save(existingProject)];
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        projectToRemove = _a.sent();
                        if (!projectToRemove) {
                            return [2 /*return*/, null];
                        }
                        return [4 /*yield*/, this.remove(projectToRemove)];
                    case 2: return [2 /*return*/, _a.sent()];
                }
            });
        });
